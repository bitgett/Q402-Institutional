...
const WHY = [
  ...
  },
  {
    ...
    body: "EIP-712 and EIP-7702 mean no native-token prompts, no gas screens, no rejected transactions from empty wallets. The same rails run through a 45-tool MCP server, so an AI agent can pay on its own, inside the per-transaction and daily caps you set.",
  },
  {
