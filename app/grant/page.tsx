...
const WHY = [
  {
    title: "12 chains. One integration. No migration.",
    body: "Native operations on BNB Chain, Ethereum, Mantle, Avalanche, Injective, X Layer, Stable, Monad, Scroll, Arbitrum, Base and Robinhood Chain through a single unified API. Not wrapped, not bridged. The multichain coverage that used to take months now takes an afternoon.",
  },
  {
    title: "Gasless for your users. And for their agents.",
    body: "EIP-712 and EIP-7702 mean no native-token prompts, no gas screens, no rejected transactions from empty wallets. The same rails run through a 46-tool MCP server, so an AI agent can pay on its own, inside the per-transaction and daily caps you set.",
  },
  {
          ...
          <section className="pt-24 lg:pt-28 pb-6 lg:pb-8">
            <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, ease: [0.22, 1, 0.36, 1] }}>
              ...
              <p className="text-lg leading-relaxed mt-7 max-w-[42rem]" style={{ color: MUT }}>
                ...
                and agentic stablecoin payments across 12 EVM chains.
              </p>
