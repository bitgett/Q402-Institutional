 ...
 *   2. Continue with Email      → magic-link signup (inline form)
 *   3. Continue with Wallet     → existing WalletModal picker (MetaMask / OKX)
 *
 * Positioning: items-center + true viewport center, z-[60] so it sits above
 * the Navbar's z-50. Earlier versions used items-start + pt-[18vh] but that
 * pushed the dialog too high; the design ask is "딱 정중앙에 떠야 하는데".
 */
            ...
            {view === "pick" && (
              <div>
                ...
                <p className="text-white/30 text-[11px] text-center mt-4">
                  Wallet is only required when your end users sign actual
                  on-chain TX — Google / email gives you the API key + 2,000
                  sponsored TX right away.
                </p>
              </div>
            )}
