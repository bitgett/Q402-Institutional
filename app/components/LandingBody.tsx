        ...
        <section className="c1-section">
          <div className="c1-wrap">
            <Shead
              ...
              sub="The SDK and 45-tool MCP server go well past one-shot payments."
            >
