...
const TABS: Tab[] = [
  ...
  },
  {
    ...
    description:
      "Micro-transactions priced at chain economics, not gas economics. Batch a tournament's prize payouts in one signed call across any of the 9 supported chains.",
  ...
  },
  {
    ...
    chips: ["9-CHAIN", "TRUST RECEIPTS", "~400ms"],
    code: [
