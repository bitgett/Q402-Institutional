...
const TABS: Tab[] = [
  {
    ...
    description:
      "Let Claude, Codex, Cursor, Cline — or your own agent — call Q402 through MCP. Start with 2,000 sponsored BNB transactions on a free Trial key, then upgrade to a Multichain Gas Tank when you outgrow it. Forty tools (q402_doctor for one-prompt setup, q402_agentic_info for Agent-Wallet introspection, recurring schedule + per-rule fire history, RedStone NAV/price triggers, stablecoin yield, Q staking, CCIP bridge, payment requests, gasless escrow), signed Trust Receipts on every settlement, sandbox-safe defaults.",
    chips: ["40 MCP TOOLS", "BATCH × 20", "TRUST RECEIPTS", "FREE TRIAL"],
    transcript: [
