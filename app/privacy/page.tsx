        ...
        <div className="space-y-10 text-sm leading-relaxed">
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2">
              ...
              <li><strong className="text-white/60">Public RPC providers</strong> — on-chain data reads (Avalanche, BSC, Ethereum, X Layer, Stable, Mantle, Injective, Monad, Scroll, Robinhood public endpoints)</li>
