...
// 04 - the full 29-tool surface, grouped like an API reference (5+2+1+7+4+2+4+1+3).
const TOOL_GROUPS = [
    ...
    <>
      ...
      <main className="font-poppins" style={{ background: "linear-gradient(180deg, #070B14 0%, #0A0F1C 100%)", color: INK }}>
        <div className="max-w-[1240px] mx-auto px-6 sm:px-8">
          ...
          <Section index="04" label="29 tools" title="The whole surface, one package.">
            <InstallBlock />
            <ToolIndex />
            <ChainStrip />
          </Section>
