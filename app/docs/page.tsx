              ...
              <table className="w-full text-sm">
                ...
                <tbody className="text-white/75">
                  {([
                    ...
                    { name: "q402_stake",               auth: "live mode",   purpose: "Gasless Q (QuackAI) staking into QuackAiStake on BNB Chain. Lock tiers 0-3 (30d/10%, 60d/15%, 120d/32%, 180d/40% APR). amount \"max\" supported. Confirm-gated + sandbox by default." },
