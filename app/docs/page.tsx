...
Q402_MULTICHAIN_API_KEY=q402_live_...`}</pre>
            ...
            <h3 className="text-xs font-semibold text-white/65 uppercase tracking-widest mb-3 mt-6">4 · Tools exposed — 46 total</h3>
            <div className="rounded-xl border border-white/8 mb-6 overflow-hidden" style={{ background: "rgba(255,255,255,0.02)" }}>
              ...
              <table className="w-full min-w-[680px] text-sm">
                ...
                <tbody className="text-white/75">
                  {([
                    ...
                    { name: "q402_yield_withdraw",      auth: "live mode",   purpose: "Withdraw supplied stablecoin out of a lending vault (amount=\"max\" = the max currently redeemable, which vault caps or queues can leave below the full position). Always allowed, even after a plan downgrade." },
