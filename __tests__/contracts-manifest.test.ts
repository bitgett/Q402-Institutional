...
const CHAINS = ["avax", "bnb", "eth", "xlayer", "stable", "mantle", "injective", "monad", "scroll"] as const;
...
describe("contracts.manifest.json ↔ public SDK", () => {
  ...
  it("SDK uses the unified TransferAuthorization witness type for all 9 chains", () => {
